...
const WizardStep = ({ currentStep, stepNumber, children }) => (
    <div
        className={`wizard-step ${currentStep === stepNumber ? "active" : ""}`}
    >
        {children}
    </div>
);
...
export default function Create({ auth }) {
    ...
    const handleAmenityChange = (e) => {
        ...
        setData(
            ...
            checked
                ...
                : data.amenities.filter((item) => item !== value),
        );
    };
    ...
    const removeImage = (indexToRemove) => {
        ...
        setData(
            "images",
            data.images.filter((_, index) => index !== indexToRemove),
        );
        setImagePreviews(
                ...
                <form id="create-property-form" onSubmit={submit}>
                    ...
                    <WizardStep currentStep={currentStep} stepNumber={3}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <InputLabel htmlFor="price" value={data.listing_type === 'rent' ? "Price (₦)" : "Sale Price (₦)"} />
                           ...
                           <div className={data.listing_type === 'rent' ? "md:col-span-2" : "md:col-span-1"}>
                                <InputLabel htmlFor="accepted_tenants" value={data.listing_type === 'rent' ? "Number of Tenants to Accept" : "Quantity Available"} />
                                <TextInput
                                    id="accepted_tenants"
                                    type="number"
                    ...
                    <WizardStep currentStep={currentStep} stepNumber={4}>
                        ...
                        <div
                            className="p-4 border-2 border-dashed rounded-lg text-center cursor-pointer bg-gray-50 hover:bg-gray-100"
                            onClick={() =>
